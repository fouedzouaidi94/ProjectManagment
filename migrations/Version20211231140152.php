 ...
 */
final class Version20211231140152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_2FB3D0EE8DB60186 ON project');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2FB3D0EE8DB60186 ON project (task_id)');
